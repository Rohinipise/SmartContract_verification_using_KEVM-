...
contract Factory {
    ...
    function createNFT(
        ...
        // initialize
        clone.initialize(_tokenName
        clone.transferOwnership(msg.sender);

        emit CreateClone(""NFT""
        return clone;
    }
    ...
    function createFundingMultitoken(
        ...
        emit CreateClone(""FundingMultitoken""
        return clone;
    }
    ...
    function createZeroCouponBond(
        ...
        emit CreateClone(""ZeroCouponBond""
        return clone;
    }
    ...
    function createBProtocolMarket(
        ...
        emit CreateClone(""BProtocolMarket""
        return clone;
    }
    ...
    function createCompoundERC20Market(
        ...
        emit CreateClone(""CompoundERC20Market""
        return clone;
    }
    ...
    function createCreamERC20Market(
        ...
        // initialize
        clone.initialize(_cToken
        clone.transferOwnership(msg.sender);

        emit CreateClone(""CreamERC20Market""
        return clone;
    }
    ...
    function createHarvestMarket(
        ...
        // initialize
        clone.initialize(_vault
        clone.transferOwnership(msg.sender);

        emit CreateClone(""HarvestMarket""
        return clone;
    }
    ...
    function predictAddress(address template
        external
        view
        returns (address)
    {
